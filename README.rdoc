...
Ruby (MRI) 2.7 and later is supported.
...
Comparison operators are supported, with behavior not adapted from platform
behavior.  On x86/amd64, the result of a comparison will be -1 if the comparison
...
Copyright © 2014-2022 Tina Wuest under the MIT license.  See LICENSE for details.
